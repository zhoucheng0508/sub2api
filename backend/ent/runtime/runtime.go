...
func init() {
	...
	// groupDescVideoPricePerRequest is the schema descriptor for video_price_per_request field.
	groupDescVideoPricePerRequest := groupFields[30].Descriptor()
	// group.VideoPricePerRequestValidator is a validator for the "video_price_per_request" field. It is called by the builders before save.
	group.VideoPricePerRequestValidator = groupDescVideoPricePerRequest.Validators[0].(func(float64) error)
