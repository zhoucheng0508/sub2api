export default {
  ...
  keys: {
    ...
    oneClick: {
      bannerTitle: 'Connect Codex in one click',
      bannerDescription: 'Generate a Codex configuration or import link with your current API key.',
      noEligibleKey: 'Create or enable an API key to connect Codex.',
      ineligibleHint: 'Codex setup requires an active, usable API key',
      action: 'One-click setup',
      dismissBanner: 'Dismiss one-click setup',
      title: 'One-click connection',
      currentKey: 'Current key: {name}',
      currentKeyLabel: 'Current API key',
      currentKeyDescription: 'Use this key to generate the import link and local configuration.',
      selectKey: 'Select an API key',
      manageKeys: 'Manage API keys',
      later: 'Maybe later',
      securityHint: 'The complete key is only placed in the configuration when you import, copy, or download a script.',
      guide: 'Setup guide',
      ccswitch: 'Method 2: CC Switch',
      script: 'Method 3: Setup script',
      guideTitle: 'Configure Codex',
      guideClientTitle: 'Configure {app}',
      installCodexAppTitle: 'Install Codex App',
      installCodexAppDescription: 'Download and install the official Codex App for {os}.',
      installCodexCliTitle: 'Install Codex CLI',
      installCodexCliDescription: 'There is no official Linux desktop app. Follow the official guide to install Codex CLI.',
      downloadCodexWindows: 'Download Codex App for Windows',
      downloadCodexMacos: 'Download Codex App for macOS',
      openCodexLinuxGuide: 'Open Codex CLI guide for Linux',
      officialAddressHint: 'Opens the official website.',
      ccSwitchDirectDownloadHint: 'Resolved by this site and downloaded directly; no release page is required.',
      installCcSwitchTitle: 'Install CC Switch',
      installCcSwitchDescription: 'Download and install CC Switch to write the API configuration for Codex.',
      installCcSwitchDescriptionFor: 'Download and install CC Switch to write the API configuration for {app}.',
      downloadCcSwitch: 'Download CC Switch',
      resolvingCcSwitch: 'Finding download...',
      architecture: 'Architecture',
      ccSwitchVersion: 'CC Switch version',
      latestVersion: 'Latest release',
      loadingVersions: 'Loading releases…',
      versionSourceHint: 'Resolved by this site',
      ccSwitchDownloadFailed: 'The automatic download could not be started.',
      openCcSwitchReleases: 'Open official Releases',
      importCodexTitle: 'Connect the API to Codex App',
      importCodexDescription: 'Open CC Switch and import the current API key into the Codex configuration.',
      selectClient: 'Choose a client to connect',
      selectClientDescription: 'Choose which CC Switch application should receive this API configuration.',
      sharedProvider: 'Uses the Claude provider',
      manualOnly: 'Add from the app',
      appUnavailable: 'This app does not support provider deeplink imports yet.',
      piManualReason: 'Add Pi providers manually from the Pi provider page in CC Switch.',
      clientDefaultModel: 'Chosen by the client',
      installClientTitle: 'Install {app}',
      installClientDescription: 'Install {app} first, then use CC Switch to write the API configuration.',
      openClientGuide: 'Open install page',
      importClientTitle: 'Connect the API to {app}',
      importClientDescription: 'Open CC Switch and import the current API key into the {app} configuration.',
      openCcSwitchFor: 'Open CC Switch and import {app}',
      ccswitchTitle: 'Import with CC Switch',
      ccswitchDescription: 'Import this service as a Codex provider in your installed CC Switch.',
      ccswitchDescriptionFor: 'Import this service as a {app} provider in your installed CC Switch.',
      client: 'Client',
      model: 'Model',
      openCcSwitch: 'Open CC Switch and import Codex',
      scriptTitle: 'Download setup script',
      cnOaiTitle: 'CN OAI setup',
      stepOne: 'Step 1',
      stepTwo: 'Step 2',
      stepThree: 'Step 3',
      cnOaiConfigureTitle: 'Configure CN OAI for Codex',
      cnOaiInstallFirst: '1. Download and install CC Switch',
      cnOaiDescription: 'For Windows 10/11. Installs the model catalog, enables image and reasoning controls, and sets up CC Switch without administrator access. Available controls do not guarantee upstream support for every effort level.',
      cnOaiPrerequisite: 'Install and open CC Switch and Codex first. Turn off proxy takeover, save your edits, and fully exit CC Switch from its tray menu before running setup. Setup never terminates the app.',
      cnOaiAutomaticModel: 'Leave blank to select an available model automatically',
      cnOaiDownload: 'Download double-click setup',
      cnOaiRun: 'After installing and fully exiting CC Switch, double-click the downloaded .cmd file. Open CC Switch and restart Codex after completion. The file contains your key; do not share it. Errors remain visible in the window.',
      cnOaiGenerateFailed: 'Could not generate setup. Check the endpoint and selected key.',
      scriptDescription: 'The script backs up your existing Codex configuration and creates a restore script before writing.',
      selectOs: 'Select operating system',
      previewComment: 'Sub2API one-click Codex setup',
      backupPreview: 'Existing files are backed up before writing and can be restored.',
      runCommand: 'Run after downloading',
      copyScript: 'Copy script',
      scriptCopied: 'Script copied',
      scriptCopyFailed: 'Copy failed. Download the script instead.',
      downloadScript: 'Download setup script',
      rollbackHint: 'The backup directory and restore command are shown after the script runs.'
    },
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
