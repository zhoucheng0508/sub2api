...
const BADGE: Record<Platform, string> = {
  ...
  seedance: 'bg-sky-500/10 text-sky-700 border-sky-500/30 dark:text-sky-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  seedance: 'bg-sky-500/10 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300',
...
const BORDER: Record<Platform, string> = {
  ...
  seedance: 'border-sky-500/20 dark:border-sky-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  seedance: 'border-sky-500/35 dark:border-sky-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  seedance: 'bg-gradient-to-r from-sky-400 to-cyan-500',
...
const TEXT: Record<Platform, string> = {
  ...
  seedance: 'text-sky-700 dark:text-sky-300',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-zinc-800 dark:text-zinc-200',
  seedance: 'text-sky-600 dark:text-sky-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  seedance: 'bg-sky-600 text-white hover:bg-sky-700 active:bg-sky-800 dark:bg-sky-600/80 dark:hover:bg-sky-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  seedance: 'bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  seedance: 'from-sky-500 to-cyan-600',
