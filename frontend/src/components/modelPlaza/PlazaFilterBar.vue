<template>
  <div class="space-y-3">
    ...
    <div class="flex items-start gap-2">
      <span class="w-10 shrink-0 pt-2 text-sm font-semibold uppercase tracking-wider text-gray-400 dark:text-dark-500">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <button
          ...
          :key="`platform-${p}`"
          type="button"
          class="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-base font-medium transition disabled:cursor-not-allowed disabled:opacity-40 disabled:grayscale"
    ...
    <div class="flex items-start gap-2">
      ...
      <div class="flex flex-wrap items-center gap-2">
        <button
          type="button"
          class="rounded-lg px-3 py-1.5 text-base font-medium transition"
        ...
        <button
          ...
          :key="`group-${g.id}`"
          type="button"
          class="rounded-lg px-3 py-1.5 text-base font-medium transition disabled:cursor-not-allowed disabled:opacity-40 disabled:grayscale"
    ...
    <div class="flex items-start gap-2">
      ...
      <div class="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          :key="`rate-${r}`"
          type="button"
          class="rounded-lg px-3 py-1.5 font-mono text-base font-medium transition disabled:cursor-not-allowed disabled:opacity-40 disabled:grayscale"
    ...
    <div class="flex flex-wrap items-start gap-2">
      ...
      <div class="relative w-full sm:w-72">
        ...
        <input
          ...
          class="input rounded-lg py-1.5 pl-9 pr-9 text-base"
