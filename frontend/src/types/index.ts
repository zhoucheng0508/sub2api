...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'seedance' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'seedance' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax'
...
export type OpenAIPromptCacheMode = 'off' | 'key_only' | 'gpt56_explicit'
